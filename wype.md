...
/***************** custom css *****************/
div#shopify-section-161105061729ad2db0, #shopify-section-collection{
  background: url("bg-02.jpg") no-repeat;
  background-size: cover;
}
#Hero-hero-2 h2.mega-title{
  color: #fff;
  font-size: 4.33333em;
  font-family: inherit;
  text-align: left;
...
.hero__inner .rte-setting{
  margin:0;
}
#shopify-section-1611045139e6c99782{
  background:url("bg-01.jpg") no-repeat;
  background-size: cover;
}


.site-footer__linklist li.site-footer__linklist-item {
  float: left;
  width: 100%;
}
...
div#shopify-section-hero-2, div#shopify-section-16101005729996657f {
  padding: 0;
}
.hero__btn{
...
.site-footer{
  background-color: #0F549B!important;
}
.site-footer__linklist-item a{
  color:#fff!important;
}
.site-footer h4, .site-footer .h4, .site-footer__social-icons .social-icons__link{
  color:#fff !important;
}
ul.list--inline.site-footer__social-icons.social-icons.site-footer__icon-list {
  text-align: right;
}
.site-footer__icons .icons__item {
  width: 20%;
  padding: 0px 5px;
}
.site-footer__rte a{
...
div#shopify-section-161105061729ad2db0 h2, #shopify-section-collection h2 {
  color: #fff;
}
.product-card__title{
  color:#fff; 
...
div#shopify-section-1610453554ee0809b6 {
  padding: 0;
  background: url(testimonials.jpg) no-repeat;
  background-size: cover;
}
...
.site-header__cart, .site-header__search, a.site-header__account:hover, a.site-header__cart:hover, .site-header__search-toggle, .site-header__search-toggle:hover, .site-header__icons .btn--link, .site-header__icons .btn--link:not([disabled]):hover{
  color: #fff;
}
...
#shopify-section-161105061729ad2db0 h2, #shopify-section-collection h2 {
  font-size: 1.7em;
  text-transform: uppercase;
  letter-spacing: 0.1em;
  font-weight: normal;
}
.medium-up--text-left h4.h3{
  font-style: normal;
  font-weight: normal;
  color: #0E68AA;
  font-size: 2.2em;
...
.template-collection .grid-view-item.product-card {
...
#shopify-section-hero-1 .page-width{
  padding-left:0;
  margin:25px;
}
.collection-slider{
...
.index-section--newsletter-background {
  background: url(https://cdn.shopify.com/s/files/1/0565/0582/7533/files/newsletter-bg.png?v=1625698902);
  background-size: cover;
  min-height:400px;
...
.one-half-column-left button.btn {
  background-color: #f28d59;
  margin-left: 19px;
  font-size: 17px;
...
div#shopify-section-161044974946232d24 {
  background: url(https://cdn.shopify.com/s/files/1/0565/0582/7533/files/newsletter-bg.png?v=1625698902) no-repeat 0 50%;
  background-size: cover;
}
...
div#shopify-section-1611210215d87d972b{
  padding:0;
}
...
.template-product .price-item, .template-product .product-card__title{
  color: #0e68aa;
}
...
.cc-color-override-1462335105 .cc-link, .cc-color-override-1462335105 .cc-link:active, .cc-color-override-1462335105 .cc-link:visited{
  color:#000 !important;
}
...
.hero__inner h2.mega-title, .hero__inner .mega-title.h2 {
  color: #fff;
  font-size: 90px;
  text-align: left;
  line-height: 100px;
...
.template-page .hero__inner h2.mega-title, .template-page .hero__inner .mega-title.h2{
  font-family: 'Conv_GothamRnd-Medium';
  font-size: 2.2em;
  text-shadow: none;
}
.template-page .hero__inner .rte-setting p{
  font-family: 'Conv_GothamRnd-Book';
  font-size: 1.1em;
  text-shadow: none;
  line-height: 30px;
}
.template-page .text-center .mega-subtitle{
  max-width: 50%;
}
.template-page div#shopify-section-hero {
  padding-bottom: 0;
}
.template-page div#shopify-section-custom-content{
  background: url(bg-01.jpg) no-repeat;
  background-size: cover;
}
...
button.shopify-payment-button__button {
  background-color: #ed8c5b !important;
  width: 100% !important;
}
.btn, .shopify-payment-button .shopify-payment-button__button--unbranded {
  background-color: #1b9acf !important;
  border-radius:37px;
}
...
{
  color: #fff !important;
  background-color: #0e68aa!important;
}
#blog a.btn.btn--tertiary.btn--small {
    padding: 13px 25px;
  font-size: 17px;
  font-family: 'Conv_GothamRnd-Medium';
}
.btn--secondary, .btn--secondary-accent, .cart__submit{
  color: #fff !important;
  background-color: #0e68aa;
  border-radius:37px;
}
.social-sharing .btn, .social-sharing .btn:not([disabled]):hover{ 
  border-radius: 0;
  background-color:transparent!important;
  border: 1px solid #1b9acf !important;
}
...
.cc-color-override-1462335105 .cc-btn{
  border-color:transparent !important;
  color: #0e68aa !important;
}

.social-sharing .btn{
  background-color: #ffffff !important;
  border: 1px solid #1b9acf;
}
.social-sharing .btn:not([disabled]):hover{
  color: #0f549b !important;
  background-color: #0e68aa;
  border: 1px solid #ed8c5b;
}
.template-index .article__grid-meta {
  display: none;
}
#shopify-section-161182436981a4196f .page-width{
  padding-left: 0px; 
  padding-right: 0px;
  margin: 0;
  max-width: 100%;
}
.product-single__description.rte li p {
  line-height: 8px;
}
div#shopify-section-custom-content-3 {
   /* background-image: url("Wype-Repeat-Flush.png");*/
    background-size: contain;
    background-repeat: no-repeat;
  background-color:#0f549b;
}
div#shopify-section-custom-content-3 h4.h2 {
    color: #FFFFFF !important;
      font-size: 3em;
    font-weight: 700;
}
#CustomImage--1-488960950421 {
    max-width: 100% !important;
    max-height: 815px !important;
}
#CustomImageWrapper--1-488960950421 {
    max-width: 100% !important;
}
div#shopify-section-custom-content-3 .custom__item.custom__item--html h3{
  font-size:2em;
}
div#shopify-section-custom-content-3 .custom__item.custom__item--html h3, div#shopify-section-custom-content-3 .custom__item.custom__item--html p, div#shopify-section-custom-content-3 .custom__item.custom__item--html p strong {
    color: #FFFFFF !important;
}
div#shopify-section-custom-content-3 .custom__item.custom__item--html h4, div#shopify-section-custom-content-3 .custom__item.custom__item--html p, div#shopify-section-custom-content-3 .custom__item.custom__item--html p strong {
    color: #FFFFFF !important;
}
div#shopify-section-custom-content-4 .custom__item-inner.custom__item-inner--html {
    text-align: center;
}
div#shopify-section-custom-content-5{
  background-image: url("orange-bg.jpg");
    background-size: cover;
    background-repeat: no-repeat;
}
div#shopify-section-custom-content-5 .page-width {
    padding-left: 150px;
    padding-right: 155px;
}
...
div#shopify-section-161182436981a4196f{
clear:both;
  padding-top:0
}
div#shopify-section-161182436981a4196f .article__grid-image-wrapper {
    margin: 0 auto;
    position: relative;
    width: 100%;
    max-width: 100% !important;
...
div#shopify-section-161182436981a4196f .article__grid-image-container {
    padding-top: 100% !important;
  margin:0;
}
div#shopify-section-161182436981a4196f .article__title{
  position:absolute;
  display:none;
  top:50%;
  text-align: center;
    width: 100%;
  background: url('orange-bg-new.png');
    padding: 15px 0;
  color:#fff;
  
}
div#shopify-section-161182436981a4196f .article__link:hover .article__title{
 display:block;
}
div#shopify-section-161182436981a4196f .article__link{
  position:relative;
  float:left;
  width:100%;
}
div#shopify-section-161182436981a4196f .article__grid-image-container img {
    max-width: 100% !important;
}
div#shopify-section-161182436981a4196f .grid__item{
padding-left:0 !important;
}
#what-is-wype #shopify-section-hero2 .mega-title.h2 {
   font-family: 'Conv_GothamRnd-Medium';
   font-size: 4.4em;
   color: #0F549B;
   text-shadow: 2px 3px 2px #fff !important;
   text-align: left;
   text-shadow: none;
}
#shopify-section-custom-content-5 h2 {
   font-size: 3em;
   color: #ffffff;

}
#blog .btn{ background-color: #ffffff!important;   } 
#shopify-section-custom-content-5 p {
   color: #ffffff;
   font-size: 1.2em;
   text-align: center;
   line-height: 28px;
...
#shopify-section-custom-content-5 p strong {
   color: #0f549b;
}
...
#what-is-wype h2.h1.mega-title.mega-title--large {
    font-size: 4.333em;
    text-align: left;
    font-weight:400;
}
#what-is-wype div#shopify-section-hero2 {
    padding-bottom: 0;  
}
#what-is-wype div#shopify-section-custom-content-2 {
  background:url('orange-bg.jpg');
  background-size: cover;
}
#what-is-wype div#shopify-section-custom-content-1{
  background: url('bg-01.jpg');
  background-size: cover;
}
#what-is-wype div#shopify-section-custom-content-4{
  background: url('bg-01.jpg');
  background-size: cover;
}
#what-is-wype h4.h3 {
...
#what-is-wype #shopify-section-custom-content-2 li{
color:#fff;
  font-size:18px;
}
#what-is-wype h3.h4 {
...
.site-header__cart-count{
background-color: #ec8c5a !important;
}
  .price__regular{
...
div#shopify-section-16125137341f677794 {
    padding: 0;
  background:url('2.png');
  background-size:cover;
}
div#shopify-section-16125137341f677794 .sign-up{
  background:none;
}
div#shopify-section-custom-section-wype-me-4 {
background: url(thing-of-booty.jpg);
background-size:contain;
background-repeat: no-repeat;
padding: 60px;
}
div#shopify-section-custom-section-wype-me-1{
padding-top:0;
}
#shopify-section-custom-section-wype-me-2 p a {
color: #0f549b;
}
#wype-me h2, #wype-me .h2 {
font-size: 2.3em;
color: #0f549b;
text-align: right;
font-weight: 600;
...
#wype-me p{font-weight:600;}
div#shopify-section-custom-section-wype-me-1 li {
margin-bottom: 24px;
font-weight: 600;
list-style: inherit;
  font-size:1.1em;
}
#what-is-wype .rte-setting.mega-subtitle.mega-subtitle {
    max-width: 65%;
    font-size: 1.1em;
    font-weight: 100;
    margin: 0;
...
#shopify-section-custom-section-1-indigeogo h4.h2 {
  font-family: 'Conv_GothamRnd-Medium';
  font-size: 3em !important;
  color:#fff;
  text-transform: uppercase;
}
#shopify-section-custom-section-1-indigeogo .section-header.text-center{
margin-bottom:0;
}
#wype-refill main#MainContent {
    padding-top: 0;
}
div#shopify-section-custom-section-1-indigeogo {
    padding-top: 55px;
  background-color: #f9cdb7;
  background: url(2021-04-12.png);
}
#shopify-section-custom-section-1-indigeogo h4.h3 {
    font-size: 1.9em;
    color: #2ba1d2;
    font-weight: 100;
  margin-bottom:0;
...
#shopify-section-custom-section-1-indigeogo .rte-setting p{
    color: #2ba1d2;
}
#shopify-section-custom-section-1-indigeogo .medium-up--one-quarter {
    width: 25%;
    padding: 0;
}
#shopify-section-custom-section-1-indigeogo .custom__item--36bb8d43-a4c8-4ea8-abd9-75ad2d38ef6d {
    margin: 0 auto;
  
}
#shopify-section-custom-section-1-indigeogo .custom__item--36bb8d43-a4c8-4ea8-abd9-75ad2d38ef6d p{
color:#fff;
}
#shopify-section-custom-section-1-indigeogo .custom__item--87241bf5-8617-430e-affb-aa349ec6562f .custom__item-inner--html{
  text-align:center;
}
.orange-btn {
    background: url(btn-orange-01.png) no-repeat;
    height: 57px;
    width: 14%;
    border:none; 
    margin-bottom: 10px;
...
.btm-btn {
    background: url(btn-blue-02.png) no-repeat;
    height: 57px;
    width: 24%;
    border:none; 
    margin-bottom: 10px;    
...
.rel-btn {
    background: url(btn-blue-01.png) no-repeat;
    height: 57px;
    width: 20%;
    border:none; 
    margin-bottom: 10px;
...
#shopify-section-custom-section-2-indigeogo a{
    border-bottom:none;
    color:#fff;
}
#shopify-section-custom-section-3-indigeogo a{
    border-bottom:none;
    color:#fff;
}
div#shopify-section-custom-section-2-indigeogo {
    padding-bottom: 0;
  padding-top: 0;
    border-top: 2px solid #fff;
}

#shopify-section-custom-section-1-indigeogo a{
    border-bottom:none;
    color:#fff;
}
#shopify-section-custom-section-2-indigeogo .custom__item--fe4640d2-5863-442f-8f43-0ab71a41b1d1 .rte-setting.rte p {
    color: #2ba1d2;
    font-size: 1.6em;
    font-weight: 700;
}
.custom__item--3816251e-7b44-494b-b44a-4ea8ba526cf4{
 background: #8DC8E8;
  padding-left: 35px;
    margin-bottom: 0;
  padding-top:10%;
...
.custom__item--39707dd7-d043-477b-803f-c2f7476e514e{
  margin-bottom:0;
}
.custom__item--3816251e-7b44-494b-b44a-4ea8ba526cf4 h4.h3{
  font-family: 'Conv_GothamRnd-Medium';
...
.custom__item--3816251e-7b44-494b-b44a-4ea8ba526cf4 p{
  color:#fff;
}
.custom__item--a663a542-d584-44d0-8bcf-11443fd664aa{
	 background: #B9DCCE;
  padding-top:10%;
  
}
.custom__item--a663a542-d584-44d0-8bcf-11443fd664aa h4.h3{
  font-family: 'Conv_GothamRnd-Medium';
  text-transform: capitalize;
  font-size: 2.3em;
  color: #2ba1d2;
...
.custom__item--a663a542-d584-44d0-8bcf-11443fd664aa p{
  color:#fff;
}
.custom__item--78a7662c-a0d1-483f-bea5-a36a1e21b145{
  padding-left:0;

}
#shopify-section-custom-section-2-indigeogo .two-thirds {
    width: 54.66667%;
}
...
div#shopify-section-custom-section-4-indigeogo {
    background: #8DC8E8;
}

#shopify-section-custom-section-4-indigeogo p{
  color: #fff;
}
#shopify-section-custom-section-4-indigeogo .rte-setting.rte p{
  color: #fff;
    font-size: 1.6em;
    font-weight: 700;
}
.video-text {
    ...
    font-size: 22px;
    border: 2px solid #f08e58;
    background-position: 5%;
}

span.video-text:hover{
background: url(play-02.png) no-repeat;
  background-size: 30px;
  background-position: 5%;
}
#wype-refill .smile-launcher-frame-container {
    display: none;
}
div#shopify-section-1617270268d25ef4f1 {
    padding-bottom: 0;
}
div#shopify-section-1617270268d25ef4f1 .hero__btn{
margin-top: 20%;
    float: none; 
    padding: 13px 24px;
    margin-left: 0px;
...
div#shopify-section-1617270268d25ef4f1 .hero__inner{
padding-bottom:0
}
div#shopify-section-1617270268d25ef4f1 .hero--small{
background-size:contain;
  background-color: #fff;
}
div#shopify-section-162547268948b8e7e4 {
...
div#shopify-section-16101005729996657f{
  min-height: 346px;
}
.offer-section{
  padding-top: 55px;
  background: url(https://cdn.shopify.com/s/files/1/0565/0582/7533/files/offer-bg.png?v=1625783319);
  background-size:cover;
}
.index-section--newsletter-background {
  background: url(https://cdn.shopify.com/s/files/1/0565/0582/7533/files/newsletter-bg.png?v=1625698902);
...
#shopify-section-1611819913c29bd7d3{
  display:none;
}
div#shopify-section-custom-section-wype-me-2 {
    background: #ed8c5b;
}
div#shopify-section-custom-section-wype-me-2 h4, div#shopify-section-custom-section-wype-me-2 p{
 color:#fff;
}
div#shopify-section-custom-section-wype-me-3 {
    background: #0f549b;
}
div#shopify-section-custom-section-wype-me-3 h3, div#shopify-section-custom-section-wype-me-3 p{
color:#fff;
}
div#shopify-section-custom-section-wype-me-1 p, div#shopify-section-custom-section-wype-me-1 li{
color: #0f549b;
}

div#shopify-section-custom-section-wype-me-4 h2, div#shopify-section-custom-section-wype-me-4 a, div#shopify-section-custom-section-wype-me-4 .custom__item-inner{  
 text-decoration:none !important;
  text-align:center;
}
div#shopify-section-custom-section-wype-me-4 .btn{
background-color: #ed8c5b !important;
  border-radius: 37px;
}
div#shopify-section-custom-section-wype-me-4 a:not(.btn){
border-bottom:none;
}
div#shopify-section-custom-section-wype-me-1 {
    padding-bottom: 0;
...
.custom__item--3816251e-7b44-494b-b44a-4ea8ba526cf4 {
background: #8DC8E8;
padding: 26px 32px 26px 65px!important;
margin-bottom: 0;
align-self: center;
}
  .custom__item--a663a542-d584-44d0-8bcf-11443fd664aa {
...
@media only screen and (max-width: 749px){
  div#shopify-section-custom-section-3-indigeogo .medium-up--text-center, div#shopify-section-custom-section-1-indigeogo .medium-up--text-center, div#shopify-section-custom-section-2-indigeogo .medium-up--text-center{
text-align: center;
}
.orange-btn {
width: 44%;
...
width: 40%;
  ...
  #what-is-wype .grid__item.small--one-half.medium-up--one-quarter.text-left {
    width: 100%;
}
  div#shopify-section-1617270268d25ef4f1 .hero__btn {
    margin-bottom: 13px;
  ...
  div#shopify-section-custom-section-wype-me-2 h4, div#shopify-section-custom-section-wype-me-1 h2{
  text-align:center;
  }
  div#shopify-section-161182436981a4196f .article__grid-image-container {
    padding-top: 100% !important;
...
font-weight: 700;
  ...
  #shopify-section-161105061729ad2db0 h2{
font-size: 1.4em;
...
.hero__btn {
  ...
  .grid.grid--uniform.grid--flush-bottom h3, .grid.grid--uniform.grid--flush-bottom .h3{
    text-align:center;
  }
  .rte-setting p{
    text-align:center;
  ...
  ul.list--inline.site-footer__social-icons.social-icons.site-footer__icon-list, .site-footer__rte {
    text-align: right;
  }  
  div#Hero-hero-1{
  ...
  .custom__item--1611045139e6c99782-0 p {
    text-align: left;
  }
  .slick-dotted.slick-slider {
    margin-bottom: 0;
  ...
  .hero__inner h2.mega-title, .hero__inner .mega-title.h2, .hero__inner .mega-title.h2{
    font-size:2.33333em !important;
    padding:0 40px;
  }
  .template-page .hero__inner h2.mega-title, .template-page .hero__inner .mega-title.h2, .template-page .hero__inner .mega-title.h2 {
    font-family: 'Conv_GothamRnd-Medium';
    font-size: 2.2em;
    text-shadow: none;
    line-height: 55px;
...
@media screen and (min-width: 768px) and (max-width: 1024px) {
  ...
  .medium-up--text-left h4.h3, .medium-up--text-left .h3.h4 {
    font-style: normal;
    font-weight: normal;
    color: #0E68AA;
    font-size: 1.6em;
  ...
  div#shopify-section-16101005729996657f .one-half-column-left, div#shopify-section-16101005729996657f .one-half-column-right {
    width:100%;
  }
  .orange-btn {
width: 22%;
...
@font-face {
	...
	src: local('☺'), url('GothamRnd-Book.woff') format('woff'), url('GothamRnd-Book.ttf') format('truetype'), url('GothamRnd-Book.svg') format('svg');
	font-weight: normal;
	font-style: normal;
}
@font-face {
	...
	src: local('☺'), url('GothamRnd-Medium.woff') format('woff'), url('GothamRnd-Medium.ttf') format('truetype'), url('GothamRnd-Medium.svg') format('svg');
	font-weight: normal;
	font-style: normal;
}
@font-face {
	font-family: 'InkFree-Normal';
	src: url('ink-free-normal.eot');
	src: local('☺'), url('ink-free-normal.woff') format('woff'), url('ink-free-normal.ttf') format('truetype'), url('ink-free-normal.svg') format('svg');
	font-weight: normal;
	font-style: normal;
}
@font-face {
	font-family: 'Porcelain';
	src: url('Porcelain.ttf');
	src: local('☺'), url('Porcelain.ttf') format('truetype');
	font-weight: normal;
	font-style: normal;
}
...
span.cozy-crd__btn.cozy-crd__confirm-button {
    background: none!important;
    padding: 8px 0 8px 0!important;
}
